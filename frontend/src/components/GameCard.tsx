import { Card, CardBody, CardFooter, CardHeader, Heading, Image, VStack } from '@chakra-ui/react';
...
const GameCard = (props: Props) => {
    const { name, imagePath, attack, defence } = props.card as CardModel;
    ...
    return (
        <motion.div
            ...
            <Card w={200} userSelect="none">
                <CardHeader >
                    <Heading as="h4" size="md" h={10}>{name}</Heading>
                </CardHeader>
                <CardBody>
                    <VStack>
